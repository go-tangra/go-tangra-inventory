// Standalone development entry: mounts the inventory routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'inventory (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
